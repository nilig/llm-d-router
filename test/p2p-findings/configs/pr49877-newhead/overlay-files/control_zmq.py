...
class ZmqTransport(ControlTransport):
    ...
    def poll(self) -> Sequence[ControlConnection]:
        ...
        """
        # Retire connections that died since the last poll() before routing
        # traffic: otherwise a reconnecting peer's first message is enqueued
        # into the dead connection and discarded along with it.
